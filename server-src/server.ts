...
const AppServerModuleNgFactory = require('../dist-server/main.1dbbbf18f249cb2226e1.bundle.js').AppServerModuleNgFactory; // bundle name set by npm script build-set-server-main-bundle
